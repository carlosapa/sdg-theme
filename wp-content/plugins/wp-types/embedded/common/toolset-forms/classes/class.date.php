...
class WPToolset_Field_Date extends FieldFactory
{
    ...
    protected $_supported_date_formats_text = array(
        'F j, Y' => 'Month dd, yyyy',
        'Y/m/d' => 'yyyy/mm/dd',
        'm/d/Y' => 'mm/dd/yyyy',
        'd/m/Y' => 'dd/mm/yyyy'
    ...
    public function enqueueScripts() {
        ...
        $js_data = array('buttonImage' => WPTOOLSET_FORMS_RELPATH . '/images/calendar.gif',
            'buttonText' => __( 'Select date' ), 'dateFormat' => $js_date_format,
    ...
    public static function timetodate( $timestamp, $format = null ) {
        ...
        return self::_isTimestampInRange( $timestamp ) ? @adodb_date( $format,
                        $timestamp ) : false;
    }
