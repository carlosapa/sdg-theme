    ...
    public static function filterConditional( $field, $post_id ){
        ...
        if ( is_array( $cond_values ) ) {
            foreach ( $cond_values as $k => &$v ) {
                ...
                $v = is_array( $v ) ? strval( array_shift( $v ) ) : $v;
            }
        }
        ...
        if ( !empty( $field['data']['conditional_display']['custom_use'] ) ) {
            ...
            foreach ( $c_fields as $c_field_id ) {
                ...
                } else if ( isset( $cond_values[$c_field_id] ) ) {
            ...
            // Regular conditional
        } else if ( !empty( $field['data']['conditional_display']['conditions'] ) ) {
            $cond = array(
            ...
            foreach ( $field['data']['conditional_display']['conditions'] as $d ) {
                ...
                if ( !empty( $c_field ) ) {
                    ...
                    // That allows checking for non-Types field
                    // TODO REVIEW THIS
                } else if ( isset( $cond_values[$d['field']] ) ) {
